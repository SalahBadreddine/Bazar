...
class PhoneVerificationPage extends StatefulWidget {
  const PhoneVerificationPage({super.key, required this.resetPassword});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Text("Verification Phone", style: KtextStyles.heading3),
            SizedBox(height: 10),
            RichText(
            ...
            PurpleButtonWidget(
              ...
              onPressed: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => widget.resetPassword
